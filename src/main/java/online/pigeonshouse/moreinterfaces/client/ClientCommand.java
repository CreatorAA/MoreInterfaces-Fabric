...
public class ClientCommand {
    ...
    public static boolean execute(String command) {
        ...
        try {
            COMMAND_DISPATCHER.get().execute(command.substring(1), commandSource);
            return true;
            ...
            commandSource.sendError(ComponentUtil.literal(e.getMessage()));
            return true;
        } finally {
    ...
    private static Component getErrorMessage(CommandSyntaxException e) {
        ...
        return context != null ? ComponentUtil.translatable("command.context.parse_error", message, e.getCursor(), context) : message;
    }
